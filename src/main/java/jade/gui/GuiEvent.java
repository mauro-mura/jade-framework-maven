...
/**
 * This class defines the object type <code>GuiEvent</code> used to notify an
 * event to a GuiAgent. It has two mandatory attributes:the source of the event
 * and an integer identifying the type of event and an optional list of
 * parameters than can be added to the event object.The type of each parameter
 * must extends <code>java.lang.Object</code>; therefore primitive object
 * (e.g.int) should be wrapped into appropriate objects(e.g
...
public class GuiEvent {
	 ...
	 * @param eventType   An integer value, identifying the kind of this event.
	 */
