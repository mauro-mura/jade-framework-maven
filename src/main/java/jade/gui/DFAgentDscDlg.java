...
public class DFAgentDscDlg extends JDialog implements ActionListener {
	...
	/*
	 * #DOTNET_INCLUDE_BEGIN private Component myComponent; private Component
	 * getOwner() {return myComponent;} #DOTNET_INCLUDE_END
	 */

	/**
	 * Create a dialog with the given parent.
	 * 
	 * @param parent The <code>Frame</code> that is the parent window of this
	 *               dialog.
	 */
	public DFAgentDscDlg(Frame parent) {
		...
		/*
		 * #DOTNET_INCLUDE_BEGIN myComponent = parent; #DOTNET_INCLUDE_END
		 */
	}
	 ...
	 * Create a dialog with the given parent.
	 * 
	 * @param parent The <code>Dialog</code> that is the parent window of this
	 *               dialog.
	 */
	 ...
	 * @param ed                  true if the fields of the gui must be editable,
	 *                            false otherwise.
	 * @param checkMandatorySlots true to verify that a value is specified for all
	 *                            the mandatory fields, false otherwise.
	 * @return a DFAgentDescription if the OK button is pressed, false if the Cancel
	 *         button is pressed.
	 */
	public DFAgentDescription ShowDFDGui(DFAgentDescription dfd, boolean ed, boolean checkMandatorySlots) {
		...
		/*
		 * lease-time panel The duration or time at which the lease time for this
		 * registration will expire. The default value of lease time is assumed to be
		 * unlimeted
		 */
	...
	private void ShowCorrect() {
		...
		try {
			...
			// #DOTNET_EXCLUDE_END
			/*
			 * #DOTNET_INCLUDE_BEGIN int x = getOwner().getX() + (getOwner().WIDTH -
			 * getWidth()) / 2; int y = getOwner().getY() + (getOwner().HEIGHT -
			 * getHeight()) / 2; #DOTNET_INCLUDE_END
			 */
