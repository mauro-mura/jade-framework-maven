...
public class AgentTree extends JPanel {
	...
	public void addAgentNode(String agentName, String agentAddress, String containerName, String agentState,
			String ownership) {
	 ...
	 */
	public void addAgentNode(AgentNode node, String containerName, String agentName, String agentAddress,
			String agentType) {
		AgentTreeModel model = getModel();
		MutableTreeNode root = (MutableTreeNode) model.getRoot();
	...
	public void modifyAgentNode(String containerName, String agentName, String address, String state,
			String ownership) {
		AgentTreeModel model = getModel();
		MutableTreeNode root = (MutableTreeNode) model.getRoot();
		// search for the folder of the local Platform
			...
			if (contName.equalsIgnoreCase(REMOTE_PLATFORMS_FOLDER_NAME)) {
				...
				while (plat_Enum.hasMoreElements()) {
					...
					if (platformNodeName.equalsIgnoreCase(HAP)) {
						...
						if (!found) {
							AgentTree.RemoteAgentNode newNode = new AgentTree.RemoteAgentNode(
									agent.getName().getName());
