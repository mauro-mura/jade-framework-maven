...
/**
 * A pattern for matching incoming ACL messages. This class allows to build
 * complex slot patterns to select ACL messages. These patterns can then be used
 * in <code>receive()</code> operations.
 * 
 * This class provide one method for each attribute of an ACLMessage, that can
 * be combined using the logic operators to create more complex patterns. A user
 * can also create an application-specific pattern. In this case he has to
 * implement the MatchExpression interface, writing the application specific
 * <code>match()</code> method. Then an instance of that class can be used as
 * parameter of the MessageTemplate constructor to define the application
 * specific MessageTemaplate.
 * 
 * 
 ...
 * @author Moreno LAGO
 * @version $Date: 2022-12-02 17:52:02 +0100 (ven, 02 dic 2022) $ $Revision:
 *          6870 $
 * 
 */
public class MessageTemplate implements Serializable {
	...
	/**
	 * This interface must be overriden in order to define an application specific
	 * MessageTemplate. In particular in the method <code> match()</code> the
	 * programmer should realize the necessary checks on the ACLMessage in order to
	 * return <b>true</b> if the message match with the application specific
	 * requirements <b>false</b> otherwise.
	 */
	public static interface MatchExpression extends Serializable {
		/**
		 * Check whether a given ACL message matches this template. Concrete
		 * implementations of this interface will have this method called to accept or
		 * refuse an ACL message.
		 * 
		 * @param msg The ACL message to match against this message template.
		 * @return A compliant implementation will return <code>true</code> if the
		 *         parameter ACL message matches the template, and <code>false</code>
		 *         otherwise.
		 */
	...
	private static class Literal implements MatchExpression {
		...
		public boolean match(ACLMessage msg) {
			...
			// case(REPLY_BY):
			// return
			// CaseInsensitiveString.equalsIgnoreCase((String)matchValue,msg.getReplyBy());
			case REPLY_BY_DATE:
	...
	private static class CustomMsgLiteral implements MatchExpression {
		...
		// use this literal for a messageTemplate matching the values of a given
		// ACLMessage.
	...
	/**
	 * Public constructor to use when the user needs to define an application
	 * specific pattern.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message.
	 * 
	 * @return A new <code>MessageTemplate</code> matching any given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:sender</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:receiver</code> slot.
	 * 
	 * @param values An array of Agent IDs against which the value of the message
	 *               slot will be matched.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message about a given topic.
	 * 
	 * @param topic An AID representing the topic to be matched
	 * @return A new <code>MessageTemplate</code> matching messages about the given
	 *         topic
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:content</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:reply-with</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:in-reply-to</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:reply-to</code> slot.
	 * 
	 * @param values An array of Agent IDs against which the value of the message
	 *               slot will be matched.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:language</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:encoding</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:ontology</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:reply-by</code> slot.
	 * 
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:protocol</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given <code>:conversation-id</code> slot.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTemplate</code> matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches any
	 * message with a given performative.
	 * 
	 * @param value The value the message slot will be matched against.
	 * @return A new <code>MessageTenplate</code>matching the given value.
	 */
	...
	/**
	 * This <em>Factory Method</em> returns a message template that matches ACL
	 * messages against a given one, passed as parameter. The following algorithm is
	 * used: When the given <code>ACLMessage</code> has a non <code>null</code>
	 * slot, subsequent messages must have the same slot value in that slot to have
	 * a match. When the given <code>ACLMessage</code> has a <code>null</code> slot,
	 * subsequent messages can have any value for that slot and still match the
	 * template. In short, a <code>null</code> value for a slot means <em>don't
	 * care</em>.
	 * 
	 * @param msg               The <code>ACLMessage</code> used to build a custom
	 *                          message template.
	 * @param matchPerformative a <code>bool</code> value. When <code>true</code>,
	 *                          the performative of the <code>msg</code> will be
	 *                          considered as a part of the template (i.e. the
	 *                          message template will match only ACL messages with
	 *                          the same performativa as <code>msg</code>). When
	 *                          <false>, the performative of <code>msg</code> is
	 *                          ignored and the resulting message template will not
	 *                          consider it when matching messages.
	 * @return A new <code>MessageTemplate</code>, matching the given message
	...
	/**
	 * Logical <b>and</b> between two <code>MessageTemplate</code> objects. This
	 * method creates a new message template that is matched by those ACL messages
	 * matching <b><em>both</b></em> message templates given as operands.
	 * 
	 * @param op1 The first <em>and</em> operand.
	 * @param op2 The second <em>and</em> operand.
	 * @return A new <code>MessageTemplate</code> object.
	 * @see jade.lang.acl.MessageTemplate#or(MessageTemplate op1, MessageTemplate
	 *      op2)
	 */
	...
	/**
	 * Logical <b>or</b> between two <code>MessageTemplate</code> objects. This
	 * method creates a new message template that is matched by those ACL messages
	 * matching <b><em>any</b></em> of the two message templates given as operands.
	 * 
	 * @param op1 The first <em>or</em> operand.
	 * @param op2 The second <em>or</em> operand.
	 * @return A new <code>MessageTemplate</code> object.
	 * @see jade.lang.acl.MessageTemplate#and(MessageTemplate op1, MessageTemplate
	 *      op2)
	 */
	...
	/**
	 * Logical <b>not</b> of a <code>MessageTemplate</code> object. This method
	 * creates a new message template that is matched by those ACL messages
	 * <b><em>not</em></b> matching the message template given as operand.
	 * 
	...
	/**
	 * Matches an ACL message against this <code>MessageTemplate</code> object.
	 * 
	 * @param msg The <code>ACLMessage</code> to check for matching.
	 * @return <code>true</code> if the ACL message matches this template,
	 ...
	 * 
	 * @return A string describing the syntactic structure of this message template.
	 */
	public String toString() {
