...
public class ACLMessage implements Cloneable, Serializable {
	...
	/**
	 * @deprecated Since every ACL Message must have a message type, you should use
...
//	#CUSTOM_EXCLUDE_BEGIN
	 ...
	 * 
	 * @param e The <code>Envelope</code> object to attach to this message.
	...
	public synchronized Object clone() {
		...
		try {
			...
			if (reply_to != null) {
				...
				Iterator<AID> it = reply_to.iterator();
				while (it.hasNext()) {
					AID id = it.next();
