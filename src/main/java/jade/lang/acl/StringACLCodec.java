...
/**
 * This class implements the FIPA String codec for ACLMessages. Notice that it
 * is not possible to convey a sequence of bytes over a StringACLCodec because
 * the bytes with the 8th bit ON cannot properly converted into a char.
 * 
...
public class StringACLCodec implements ACLCodec {
	...
	/**
	 * String constant for the name of the ACL representation managed by this ACL
	 * codec.
	 */
	 ...
	 * ACL messages. The standard output is used to write encoded ACL messages.
	 */
	 ...
	 *            <code>new InputStreamReader(System.in)</code> if you want to use
	 *            the standard input)
	 * @parameter w is the writer to write encoded ACL messages (pass
	 *            <code>new OutputStreamWriter(System.out)</code> if you want to use
	 *            the standard output)
	 */
	...
	/**
	 * Take a java String and quote it to form a legal FIPA ACL string. Add
	...
	/**
	 * If a user-defined parameter contain a blank char inside, then it is skipped
	 * for FIPA-compatibility
	 * 
	...
	/**
	 * If the content of the message is a byteSequence, then this method encodes the
	 * content in Base64 and automatically sets the value of the encoding slot.
	 * 
	...
	/**
	 * append to the passed StringBuffer the slot name and value separated by a
	 * blank char and followed by a newline. If the value contains a blank, then it
	 * is quoted. if the value is null or its length is zero, the method does
	 * nothing.
	 **/
	public static void appendACLExpression(StringBuilder str, String slotName, String slotValue) {
	...
	/**
	 * Test if the given string is a legal word using the FIPA ACL spec. In addition
