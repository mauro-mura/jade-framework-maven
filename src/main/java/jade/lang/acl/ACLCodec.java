...
/**
 * Abstract interface for converting ACL messages back and forth between Java
 * objects and raw byte sequences, according to a FIPA ACL message
 * representation.
 * 
...
public interface ACLCodec {
	...
	// #DOTNET_EXCLUDE_END
	/*
	 * #DOTNET_INCLUDE_BEGIN public static final String DEFAULT_CHARSET =
	 * "ISO-8859-1"; #DOTNET_INCLUDE_END
	 */
	...
	public static class CodecException extends Exception {
		...
		private static final long serialVersionUID = -9060206322805166185L;
		/**
		 * @serial
		 */
		 ...
		 * 
		 * @return the <code>Throwable</code> object that is the exception thrown by the
		 *         concrete parsing subsystem.
		 */
