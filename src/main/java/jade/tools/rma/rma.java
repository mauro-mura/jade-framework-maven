...
/**
 * <em>Remote Management Agent</em> agent. This class implements <b>JADE</b>
 * <em>RMA</em> agent. <b>JADE</b> applications cannot use this class directly,
 * but interact with it through <em>ACL</em> message passing. Besides, this
 * agent has a <em>GUI</em> through which <b>JADE</b> Agent Platform can be
 * administered.
 * 
 * 
 * @author Giovanni Rimassa - Universita' di Parma
 * @author Moreno LAGO
 * @version $Date: 2013-01-07 13:03:08 +0100 (lun, 07 gen 2013) $ $Revision:
 *          6621 $
 * 
 */
public class rma extends ToolAgent {
	...
	/**
	 * This method starts the <em>RMA</em> behaviours to allow the agent to carry on
	 * its duties within <em><b>JADE</b></em> agent platform.
	 */
	...
	public void addRemotePlatformFromURL(String url) {
		...
		try {
			...
			BufferedReader in = new BufferedReader(new InputStreamReader(apUrl.openStream()));
			...
			String content = "(( result (action ( agent-identifier :name ams :addresses (sequence IOR:00000000000000) :resolvers (sequence ) ) (get-description ) ) (sequence "
					+ buf.toString() + " ) ) )";
