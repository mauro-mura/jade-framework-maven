...
/**
 * This class is used to show a list of AIDs. AIDs can be edited, inserted and
 * deleted.
 *
...
public class ACLAIDList extends JPanel {
	...
	/**
	 * Triggered when pressing a key. Enter will call doView(), Insert will call
	 * doAdd(), and Delete will call doDelete().
	 *
	...
	private void jbInit() throws Exception {
		...
		this.add(viewButton, new GridBagConstraints(2, 0, GridBagConstraints.REMAINDER, 1, 0.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
		this.add(contentScrollPane, new GridBagConstraints(0, 0, 1, 3, 1.0, 1.0, GridBagConstraints.CENTER,
	...
	public class AIDListCellRenderer extends JLabel implements ListCellRenderer {
		...
		/**
		 * Gets the ListCellRendererComponent attribute of the AIDListCellRenderer
		 * object
		 *
	...
	public class AIDListListener implements ListDataListener {
		...
		public void contentsChanged(ListDataEvent parm1) {
			...
			String theType = "jade.core.AID";
			try {
				Method removeMethod = itsObj.getClass().getMethod(removeMethodName,
						new Class[] { Class.forName(theType) });
