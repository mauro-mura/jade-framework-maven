...
/**
 * This can be used as test agent for sending and receiving messages to the
 * Agentplatform and Other agents. A couple of message templates are included in
 * the menu.
 *
...
public class TestAgent extends Agent {
	...
	public void doSearchAMS() {
		...
		searchConstraints.setMaxDepth(Long.valueOf(100));
		searchConstraints.setMaxResults(Long.valueOf(100));
	...
	private class SplashScreen extends JWindow {
		...
		void jbInit() {
			...
			this.getContentPane().add(jPanel1, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
			jPanel1.add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
			jPanel1.add(theProgressBar, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.SOUTHEAST,
