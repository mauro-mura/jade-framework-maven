...
public class DFAgentDescription implements Concept {
	...
	/**
	 * Set the lease time for the registration of this DFAgentDescription as an
	 * absolute time.
	 * 
	 * @param absoluteTime The lease time for the registration of this
	 *                     DFAgentDescription as an absolute time. Use
	 *                     <code>null</code> (default) to indicate an infinite lease
	 *                     time
	 */
	...
	/**
	 * Retrieve the lease time for the registration of this description (i.e., how
	 * long it will be kept within the DF agent knowledge base).
	 * 
	 ...
	 * 
	 * @return If the lease time expired, <code>true</code> is returned, and
	...
	/**
	 * Add a service description to the <code>service</code> slot collection of this
	 * object.
	 * 
	...
	/**
	 * Remove all service descriptions from the <code>services</code> slot
	...
	/**
	 * Access all service descriptions from the <code>services</code> slot
	 * collection of this object.
	 * 
	...
	/**
	 * Add a protocol name to the <code>protocols</code> slot collection of this
	 * object.
	 * 
	...
	/**
	 * Remove a protocol name from the <code>protocols</code> slot collection of
	 * this object.
	 * 
	...
	/**
	 * Remove all protocol names from the <code>protocols</code> slot collection of
	 * this object.
	 */
	...
	/**
	 * Access all protocol names from the <code>protocols</code> slot collection of
	 * this object.
	 * 
	...
	/**
	 * Add an ontology name to the <code>ontologies</code> slot collection of this
	 * object.
	 * 
	...
	/**
	 * Remove an ontology name from the <code>ontologies</code> slot collection of
	 * this object.
	 * 
	...
	/**
	 * Remove all ontology names from the <code>ontologies</code> slot collection of
	 * this object.
	 */
	...
	/**
	 * Access all ontology names from the <code>ontologies</code> slot collection of
	 * this object.
	 * 
	...
	/**
	 * Add a content language name to the <code>languages</code> slot collection of
	 * this object.
	 * 
	...
	/**
	 * Remove a content language name from the <code>languages</code> slot
	 * collection of this object.
	 * 
	...
	/**
	 * Remove all content language names from the <code>languages</code> slot
	 * collection of this object.
	 */
	...
	/**
	 * Access all content language names from the <code>languages</code> slot
	 * collection of this object.
	 * 
