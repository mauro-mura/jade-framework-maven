...
public class AMSAgentDescription implements Concept {
	...
	/**
	 * String constant for the <code>initiated</code> agent life-cycle state.
	 */
	public static final String INITIATED = "initiated";

	/**
	 * String constant for the <code>active</code> agent life-cycle state.
	 */
	public static final String ACTIVE = "active";

	/**
	 * String constant for the <code>suspended</code> agent life-cycle state.
	 */
	public static final String SUSPENDED = "suspended";

	/**
	 * String constant for the <code>waiting</code> agent life-cycle state.
	 */
	public static final String WAITING = "waiting";

	/**
	 * String constant for the <code>transit</code> agent life-cycle state.
	 */
	public static final String TRANSIT = "transit";

	/**
	 * String constant for the <code>latent</code> agent life-cycle state. JADE
	 * specific state indicating an agent waiting to be restored after a crash of
	 * the main container
	 */
	 ...
	 * 
	 * @return The value of the <code>name</code> slot, or <code>null</code> if no
	 *         value was set.
	 */
	public AID getName() {
		return name;
	 ...
	 * 
	 * @return The value of the <code>ownership</code> slot, or <code>null</code> if
	 *         no value was set.
	 */
	 ...
	 * 
	 * @return The value of the <code>state</code> slot, or <code>null</code> if no
	 *         value was set.
	 */
	...
	public String toString() {
		return "AMSAgentDescription [name=" + name + ", ownership=" + ownership + ", state=" + state + "]";
	}
