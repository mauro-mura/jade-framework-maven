...
/**
 * 
 * This class represents the <code>debug-off</code> action, requesting a
 * debugger to stop observing a set of agents in the platform.
 * 
...
public class DebugOff implements AgentAction {
	...
	/**
	 * Retrieve the value of the <code>debugger</code> slot of this action,
	 * containing the agent identifier of the debugger agent.
	 * 
	 * @return The value of the <code>debugger</code> slot, or <code>null</code> if
	 *         no value was set.
	 */
	...
	/**
	 * Remove all agent identifiers from the <code>debugged-agents</code> slot
	...
	/**
	 * Add an agent identifier to the <code>debugged-agents</code> slot collection
	 * of this object.
	 * 
	...
	/**
	 * Remove an agent identifier from the <code>debugged-agents</code> slot
	 * collection of this object.
	 * 
	...
	/**
	 * Access all agent identifiers from the <code>debugged-agents</code> slot
	 * collection of this object.
	 * 
	 ...
	 * <code>getAllDebuggedAgents()</code> cannot be used as it returns an
