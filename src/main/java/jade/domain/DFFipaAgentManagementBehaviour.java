 ...
 * by the DF. It extends RequestManagementBehaviour and implements
 * performAction() to i) call the method of the DF corresponding to the
 * requested action and ii) prepare the result notification.
 * 
...
class DFFipaAgentManagementBehaviour extends RequestManagementBehaviour {
	...
	/**
	 * Call the proper method of the DF and prepare the notification message
	 */
