...
public class DFService extends FIPAService {
	...
	private static void encodeDfd(StringBuilder sb, DFAgentDescription dfd) {
		sb.append('(');
	...
	private static void encodeServiceDescription(StringBuilder sb, ServiceDescription sd) {
		sb.append('(');
	...
	private static void encodeProperty(StringBuilder sb, Property p) {
		sb.append('(');
	...
	private static void encodeMultiValueProperty(StringBuilder sb, MultiValueProperty mvp) {
		sb.append('(');
	...
	private static void encodeField(StringBuilder sb, Object val, String name) {
		if (val != null) {
			sb.append(SPACE_COLON);
			sb.append(name);
			sb.append(' ');
	...
	private static void encodeAggregate(StringBuilder sb, Iterator agg, String aggType, String name) {
