...
/**
 * Singleton Iterator for an empty collection. The usage of the
 * singleton-pattern for this simple object allows just to save some memory.
 * 
...
public final class EmptyIterator implements Iterator {
	...
	/**
	 * Returns the singleton EmptyIterator object. Most of the methods of this class
	 * are instance methods and must be invoked with respect to the singleton
	 * object.
	 **/
	 ...
	 * @throws NoSuchElementException Always, because the underlying collection is
	 *                                always empty.
	 */
	public Object next() {
	 ...
	 * 
	 * @throws RuntimeException Always, because the underlying collection is always
	 *                          empty.
	 */
	public void remove() {
