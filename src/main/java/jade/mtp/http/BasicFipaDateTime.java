...
public class BasicFipaDateTime {
	...
	public String toString() {
		String str_date = cal.get(Calendar.YEAR) + paddedInt(2, cal.get(Calendar.MONTH) + 1)
		...
		str_date = str_date + paddedInt(2, cal.get(Calendar.MINUTE)) + paddedInt(2, cal.get(Calendar.SECOND))
	...
	/*
	 * // For testing purposes only public static void main(String[] arg) {
	 * System.out.println("Initial date: 20030812Z171910154"); BasicFipaDateTime
	 * bfdt = new BasicFipaDateTime("20030812Z171910154");
	 ...
	 * System.out.println("Milli: "+bfdt.getMilliseconds()); System.out.println(new
	 * BasicFipaDateTime(new BasicFipaDateTime("20030812Z171910154").getTime()));
	 * System.out.println(); System.out.println("Current date: "+new
	 * BasicFipaDateTime(new Date()).toString()); }
	 */
