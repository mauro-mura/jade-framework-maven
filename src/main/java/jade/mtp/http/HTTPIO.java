...
public class HTTPIO {
	...
	private static final byte[] PROXY = { (byte) 'P', (byte) 'r', (byte) 'o', (byte) 'x', (byte) 'y', (byte) '-',
			(byte) 'C', (byte) 'o', (byte) 'n', (byte) 'n', (byte) 'e', (byte) 'c', (byte) 't', (byte) 'i', (byte) 'o',
			(byte) 'n', (byte) ':', (byte) ' ' };
	...
	private static final byte[] CONTENT = { (byte) 'C', (byte) 'o', (byte) 'n', (byte) 't', (byte) 'e', (byte) 'n',
			(byte) 't', (byte) '-', (byte) 'T', (byte) 'y', (byte) 'p', (byte) 'e', (byte) ':', (byte) ' ' };
	private static final String CONTENT_STR = "Content-Type: ";
	private static final byte[] CLENGTH = { (byte) 'C', (byte) 'o', (byte) 'n', (byte) 't', (byte) 'e', (byte) 'n',
			(byte) 't', (byte) '-', (byte) 'L', (byte) 'e', (byte) 'n', (byte) 'g', (byte) 't', (byte) 'h', (byte) ':',
			(byte) ' ' };
	private static final byte[] MM = { (byte) 'm', (byte) 'u', (byte) 'l', (byte) 't', (byte) 'i', (byte) 'p',
			(byte) 'a', (byte) 'r', (byte) 't', (byte) '/', (byte) 'm', (byte) 'i', (byte) 'x', (byte) 'e',
			(byte) 'd' };
	private static final String MM_STR = "multipart/mixed";
	private static final byte[] BND = { (byte) 'b', (byte) 'o', (byte) 'u', (byte) 'n', (byte) 'd', (byte) 'a',
			(byte) 'r', (byte) 'y' };
	private static final String BND_STR = "boundary";
	private static final byte[] APPLI = { (byte) 'a', (byte) 'p', (byte) 'p', (byte) 'l', (byte) 'i', (byte) 'c',
			(byte) 'a', (byte) 't', (byte) 'i', (byte) 'o', (byte) 'n', (byte) '/' };
	private static final byte[] CONN = { (byte) 'C', (byte) 'o', (byte) 'n', (byte) 'n', (byte) 'e', (byte) 'c',
	...
	private static final byte[] HTTP = { (byte) 'H', (byte) 'T', (byte) 'T', (byte) 'P', (byte) '/', (byte) '1',
			(byte) '.', (byte) '1' };
	private static final byte[] CACHE = { (byte) 'C', (byte) 'a', (byte) 'c', (byte) 'h', (byte) 'e', (byte) '-',
			(byte) 'C', (byte) 'o', (byte) 'n', (byte) 't', (byte) 'r', (byte) 'o', (byte) 'l', (byte) ':', (byte) ' ',
			(byte) 'n', (byte) 'o', (byte) '-', (byte) 'c', (byte) 'a', (byte) 'c', (byte) 'h', (byte) 'e' };
	private static final byte[] MIME = { (byte) 'M', (byte) 'i', (byte) 'm', (byte) 'e', (byte) '-', (byte) 'V',
			(byte) 'e', (byte) 'r', (byte) 's', (byte) 'i', (byte) 'o', (byte) 'n', (byte) ':', (byte) ' ', (byte) '1',
			(byte) '.', (byte) '0' };
	...
	private static final byte[] MIME_MULTI_PART_HEADER = { (byte) 'T', (byte) 'h', (byte) 'i', (byte) 's', (byte) ' ',
			(byte) 'i', (byte) 's', (byte) ' ', (byte) 'n', (byte) 'o', (byte) 't', (byte) ' ', (byte) 'p', (byte) 'a',
			(byte) 'r', (byte) 't', (byte) ' ', (byte) 'o', (byte) 'f', (byte) ' ', (byte) 't', (byte) 'h', (byte) 'e',
			(byte) ' ', (byte) 'M', (byte) 'I', (byte) 'M', (byte) 'E', (byte) ' ', (byte) 'm', (byte) 'u', (byte) 'l',
			(byte) 't', (byte) 'i', (byte) 'p', (byte) 'a', (byte) 'r', (byte) 't', (byte) ' ', (byte) 'e', (byte) 'n',
			(byte) 'c', (byte) 'o', (byte) 'd', (byte) 'e', (byte) 'd', (byte) ' ', (byte) 'm', (byte) 'e', (byte) 's',
			(byte) 's', (byte) 'a', (byte) 'g', (byte) 'e', (byte) '.' };
	private static final byte[] XML = { (byte) 'x', (byte) 'm', (byte) 'l' };
	private static final byte[] CHARSET = { (byte) ';', (byte) ' ', (byte) 'c', (byte) 'h', (byte) 'a', (byte) 'r',
			(byte) 's', (byte) 'e', (byte) 't', (byte) '=' };
	private static final byte[] TEXT = { (byte) 't', (byte) 'e', (byte) 'x', (byte) 't' };
	private static final byte[] TEXT_HTML = { (byte) 't', (byte) 'e', (byte) 'x', (byte) 't', (byte) '/', (byte) 'h',
			(byte) 't', (byte) 'm', (byte) 'l' };
	private static final byte[] HTML_BEGIN = { (byte) '<', (byte) 'h', (byte) 't', (byte) 'm', (byte) 'l', (byte) '>',
			(byte) '<', (byte) 'b', (byte) 'o', (byte) 'd', (byte) 'y', (byte) '>', (byte) '<', (byte) 'h', (byte) '1',
			(byte) '>' };
	private static final byte[] HTML_END = { (byte) '<', (byte) '/', (byte) 'h', (byte) '1', (byte) '>', (byte) '<',
	...
	/**
	 * Create a generic message of HTTP with the input msgCode and type of
	...
	/**
	 * Blocks on read until something is available on the stream or the stream is
	 * closed
	 */
	/*
	 * public static String blockOnRead(BufferedReader br) throws IOException {
	 * //Skip empty lines String line = null; while(BLK.equals(line=br.readLine()));
	 * return line; }
	 */
	...
	public static String readAll(InputStream input, StringBuffer xml, OutputStream acl, StringBuffer type)
		...
		/*
		 * if(xml.length()>0) xml.delete(0,xml.length()); if(acl.length()>0)
		 * acl.delete(0,acl.length()); if(connection.length()>0)
		...
		while (!BLK.equals(line = readLineFromInputStream(input))) {
			...
			/*
			 * // NL do not test MIME version for interoperability with other MTP if
			 * (line.toLowerCase().startsWith(MIME.toLowerCase())) { foundMime = true; }
			 */
		...
		return OK;
		/*
		 * } catch(NullPointerException npe) { // readLine returns null <--> EOF
		 * System.out.println("null pointer in readAll"); //npe.printStackTrace();
		 * type.append(CLOSE); return ERROR; }
		 */
	}

	/**
	 * Capture and return the code of response message, this message is received
	 * from client
	 */
	...
	/**
	 * Reads byte sequence from specified input stream into specified output stream
	 * up to specified byte sequence pattern is occurred. The output byte sequence
	 * does not contains any bytes matched with pattern. If the specified pattern
	 * was not found until the input stream reaches at end, output all byte sequence
	 * up to end of input stream and returns false.
	 *
	 ...
	 * These characters must be 7-bit character, and stored only low-byte of each
	 * code.
	 *
	 * @param output specified output stream.
