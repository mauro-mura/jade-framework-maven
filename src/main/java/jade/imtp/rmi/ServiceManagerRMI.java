...
public interface ServiceManagerRMI extends Remote {
	...
	String addNode(NodeDescriptor dsc, List<ServiceDescriptor> nodeServices, boolean propagated) throws RemoteException, ServiceException, JADESecurityException;
