...
public interface ICP {
	...
	public static interface Listener {
		...
		/**
		 * Handle a received (still serialized) command object, i.e. deserialize it and
		 ...
		 * @exception LEAPSerializationException if an error occurs during the LEAP
		 *                                       surrogate serialization mechanism
		 */
	 ...
	 */
	public byte[] deliverCommand(TransportAddress ta, byte[] payload, boolean requireFreshConnection)
			throws ICPException;
