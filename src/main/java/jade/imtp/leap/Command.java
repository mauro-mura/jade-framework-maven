...
public class Command {
	 ...
	 */
	private List<Object> commandParameters;
	...
	/**
	 * Allows reusing the same object to deal with another command. Generally used
	 * to build a response to an incoming command.
	 */
	void reset(int code) {
		commandCode = code;
		objectID = DUMMY_ID;
	 ...
	 * <code>java.lang.StringBuffer</code> object to the end of the argument list of
	 * this command object.
	 * 
	 * @param param the parameter object to be added at the end of the argument list
	 * @see Deliverable
	...
	public String toString() {
		return "Command [commandCode=" + commandCode + ", objectID=" + objectID + ", commandParameters="
				+ commandParameters + ", requireFreshConnection=" + requireFreshConnection + "]";
	}
