...
/**
 * The default introspector for user defined ontologies that uses Java
 * Reflection to translate java objects to/from abstract descriptors.
 * 
...
public class ReflectiveIntrospector implements Introspector {
	...
	public void setSlotValue(String slotName, Object slotValue, Object obj, ObjectSchema schema)
	...
	protected void invokeSetterMethod(Method method, Object obj, Object value) throws OntologyException {
		try {
			...
			throw new OntologyException("Error invoking setter method " + method.getName() + " on object " + obj
					+ " with parameter " + value, e);
		}
	}
	// #APIDOC_EXCLUDE_END

	/**
	 * Check the structure of a java class associated to an ontological element to
	 * ensure that translations to/from abstract descriptors and java objects
	...
	public AbsAggregate externalizeAggregate(String slotName, Object obj, ObjectSchema schema, Ontology referenceOnto)
			throws OntologyException {
	...
	public Object internalizeAggregate(String slotName, AbsAggregate abs, ObjectSchema schema, Ontology referenceOnto)
			throws OntologyException {
	...
	public AbsObject externalizeSpecialType(Object obj, ObjectSchema schema, Class<?> javaClass, Ontology referenceOnto)
			throws OntologyException {
		throw new NotASpecialType();
	}

	public Object internalizeSpecialType(AbsObject abs, ObjectSchema schema, Class<?> javaClass, Ontology referenceOnto)
			throws OntologyException {
		throw new NotASpecialType();
	}
}
