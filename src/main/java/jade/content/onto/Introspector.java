...
/**
 * This interface defines the methods to convert objects of ontological classes
 * into/from abstract descriptors. Each ontology has an
 * <code>Introspector</code> and delegates it the conversion.
 * 
