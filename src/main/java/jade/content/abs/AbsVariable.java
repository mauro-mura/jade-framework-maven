...
/**
 * An abstract descriptor that can hold a variable expression, i.e. an entity
...
public class AbsVariable extends AbsObjectImpl implements AbsTerm {
	 ...
	 * @param valueType The type of values that can be assigned to this variable.
	 *
	 */
	 ...
	 * 
	 * @return The type of values that can be assigned to this variable.
	 */
	...
	/**
	 * Redefine the <code>isGrounded()</code> method in order to always return
	 * <code>false</code>.
	 */
	@Override
	...
	/**
	 * Return true if this object represents a meta term (i.e. symbol ??x) rather
	 * than a concrete variable. This method is currently used only by the semantics
	 * framework.
	 * 
	...
	/**
	 * Sets the value of isMetaTerm, where the default is false. This method is
	 * currently used only by the semantics framework.
	 * 
	 * @since JADE3.4
	 **/
