...
/**
 * An abstract descriptor that can hold a list of generic content element
 * expressions.
 * 
...
public class AbsContentElementList implements AbsContentElement {
	...
	/**
	 * Add a new element (that must be a content element) to this content element
	 * list.
	 * 
	...
	/**
	 * @return An <code>Iterator</code> over the elements of this content element
	 *         list.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the given content element is contained in this
	 ...
	 * 
	 * @return The position of an element within this content element list or -1 if
	 *         the given element is not contained in this content element list.
	 */
	 ...
	 * 
	 * @return <code>true</code> if this content element list does not contain any
	 *         element.
	 */
	 ...
	 * 
	 * @return An array containing all elements in this content element list.
	 */
	...
	/*
	 * protected void dump(int indent, PrintStream ps) { ps.println(toString()); }
	 */
	...
	/**
	 * Tests if this AbsContentElementList is grounded, i.e., if no one of its
	 * elements is associated with a variable
	 * 
	 * @return <code>true</code> if the object is grounded.
	 */
	public boolean isGrounded() {
		Iterator<AbsContentElement> it = elements.iterator();
		while (it.hasNext()) {
			AbsContentElement abs = it.next();
			if (!abs.isGrounded()) {
				return false;
			}
		}
