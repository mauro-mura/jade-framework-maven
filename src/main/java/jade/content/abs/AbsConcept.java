...
public class AbsConcept extends AbsPrimitiveSlotsHolder implements AbsTerm, Concept {
	 ...
	 * PERSON, ADDRESS...).
	 * 
	 * @param typeName The name of the type of the concept held by this abstract
	 *                 descriptor.
	 */
	...
	/**
	 * Gets the value of an attribute of the concept held by this abstract
	 * descriptor.
	 * 
	...
	private static Class<?> absConceptClass;
