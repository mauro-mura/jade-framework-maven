...
/**
 * An abstract descriptor that can hold an aggregate entity expression.
 * 
...
public class AbsAggregate extends AbsConcept {
	...
	/**
	 * Construct an Abstract descriptor to hold an aggregate of the proper type
	 * (i.e. SET, SEQUENCE...).
	 * 
	 * @param typeName The name of the type of the aggregate held by this abstract
	 *                 descriptor.
	 */
	...
	/**
	 * @return An <code>Iterator</code> over the elements of this aggregate.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the given term is contained in this aggregate.
	 */
	 ...
	 * 
	 * @return <code>true</code> if this aggregate does not contain any element.
	 */
	...
	public AbsObject getAbsObject(String name) {
		return elements.get(toIndex(name));
	}
	...
	/**
	 * Tests if this AbsAggregate is grounded, i.e., if no one of its elements is
