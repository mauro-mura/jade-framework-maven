...
/**
 * Utility class that allow using an <code>ACLMessage</code> object as an
 * ontological agent action.
 * 
...
public class OntoACLMessage extends ACLMessage implements AgentAction {
	...
	/**
	 * Construct an ontological ACL message whose performative is
	 ...
	 * 
	 * @param msg the <code>ACLMessage</code>to be wrapped. If <code>msg</code> is
	 *            already an ontological ACL message no new object is created and
	 *            <code>msg</code> is returned with the sender and receivers
	 *            properly wrapped if necessary.
	 */
	...
	/**
	 * This method is redefined so that the sender AID is automatically wrapped into
	 * an OntoAID
	 */
	...
	/**
	 * This method is redefined so that the receiver AID is automatically wrapped
	 * into an OntoAID
	 */
	...
	/**
	 * This method is redefined so that the replyTo AID is automatically wrapped
	 * into an OntoAID
	 */
