...
public interface PlatformManager {
	 ...
	 */
	String addNode(NodeDescriptor dsc, List<ServiceDescriptor> nodeServices, boolean propagated) throws IMTPException, ServiceException, JADESecurityException;
	...
	Vector<Slice> findAllSlices(String serviceKey) throws IMTPException, ServiceException;
