...
public class FaultRecoveryService extends BaseService {
	...
	public Slice getLocalSlice() {
		return new Slice() {
			...
			private static final long serialVersionUID = -4794005433862223715L;
