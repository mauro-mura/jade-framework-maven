...
interface AgentToolkit {
	...
	// void handleSave(AID agentID, String repository) throws ServiceException,
	// NotFoundException, IMTPException;
	// void handleReload(AID agentID, String repository) throws ServiceException,
	// NotFoundException, IMTPException;
	// void handleFreeze(AID agentID, String repository, ContainerID
