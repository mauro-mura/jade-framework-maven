 ...
 * @author Moreno LAGO
 * @version $Date: 2005-06-13 19:10:41 +0200 (lun, 13 giu 2005) $ $Revision:
 *          5716 $
 */
public class BehaviourList extends LinkedList<Behaviour> implements Serializable {
	...
	/**
	 * Remove b from the list. If b was in the list, return true otherwise return
	 * false. This requires adjusting the current index in the following cases: -
	 * the index of the removed Behaviour is < than the current index - the removed
	 * Behaviour is the current one and it is also the last element of the list. In
	 * this case the current index must be set to 0
	 */
	...
	/**
	 * Advance the current index (taking into account wrap around) and return the
