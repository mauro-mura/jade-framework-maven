...
public class OutcomeManager implements Serializable {
	...
	/**
	 * Retrieve the exit-code that indicates whether the behaviour holding this
	 * OutcomeManager succeeded (<code>OK</code>) or failed (<code>KO</code>)
	 * 
	 * @return The exit-code that indicates whether the behaviour holding this
	 *         OutcomeManager succeeded (<code>OK</code>) or failed
	 *         (<code>KO</code>)
	 */
	...
	/**
	 * Retrieve the error-message providing details about the reason of failure of
	 * the behaviour holding this OutcomeManager .
	 * 
	 * @return The error-message providing details about the reason of failure of
	 *         the behaviour holding this OutcomeManager or null if the behaviour
	 *         succeeded
	 */
	...
	/**
	 * Mark the behaviour holding this OutcomeManager as failed and store the
	 * error-message that can then be retrieved by means of the
