 ...
 * <code>send()</code> as an atomic operation. This behaviour sends a given ACL
...
public final class SenderBehaviour extends OneShotBehaviour {
	...
	/**
	 * Actual behaviour implementation. This method sends an ACL message, using
	 * either the given <code>AgentGroup</code> or the <code>:receiver</code>
	 * message slot to get the message recipient names.
	 */
	public void action() {
