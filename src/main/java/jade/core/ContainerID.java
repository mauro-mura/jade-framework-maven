...
/**
 * A class identifying an agent container in the JADE platform. This class is a
 * simple descriptor of JADE containers, holding their name and a few other data
 * about them.
 * 
...
public class ContainerID implements Location {
	...
	/**
	 * String constant identifying the JADE default Internal Message Transport
	 * Protocol, connecting different containers within the same JADE platform.
	 */
	 ...
	 * @param a The network address of the node where the described container is
	 *          deployed.
	 */
	 ...
	 * 
	 * @return The container name if one is set, or <code>null</code> otherwise.
	 */
	...
	/**
	 * Set the IP address (as a string) of the host, the described container is
	 * running on.
	 * 
	 * @param a The string representation of the IP address of the host, the
	 *          described container is running on.
	 */
	 ...
	 * 
	 * @return The string representation of the IP address of the host, the
	 *         described container is running on.
	 */
	...
	/**
	 * Retrieve a string identifying the described container. The string is composed
	 * by the container name, the <i>@</i> symbol and the transport URL string.
	 * 
	...
	/**
	 * Retrieve a string representation for this container ID. The string returned
	 * is the ID string of the described container.
	 * 
	...
	/**
	 * Equality operation over container IDs. Two <code>ContainerID</code> objects
	 * are considered equal if and only if their name is the same (a case
	 * insensitive string comparison is used.
	 * 
	 * @param obje The right hand side of the equality operation, the left hand side
	 ...
	 * hash code for a container ID, so that two container IDs with the same name
	 * (case insensitively) have the same hash code.
	 */
	public int hashCode() {
