...
public class TopicManagementService extends BaseService {
	...
	// Utility methods
	///////////////////////////////////////////////////
	private void broadcastRegistration(AID aid, AID topic, List<Slice> slices) throws ServiceException {
		...
		for (int i = 0; i < slices.size(); i++) {
			...
			try {
				TopicManagementSlice slice = (TopicManagementSlice) slices.get(i);
	...
	private void broadcastDeregistration(AID aid, AID topic, List<Slice> slices) throws ServiceException {
		if (myLogger.isLoggable(Logger.CONFIG)) {
