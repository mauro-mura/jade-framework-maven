...
/**
 * Processes JADE kernel-level commands, managing a filter/sink system to
...
public class CommandProcessor {
	 ...
	 * @param direction Whether to add this filter to the outgoing or incoming
	 *                  filter chain.
	 */
	 ...
	 * 
	 * @return The Filter at the beginning of the chain (may have changed)
	 */
	 ...
	 *                     commands.
	 * @param side         One of the two constants <code>Sink.COMMAND_SOURCE</code>
	 *                     or <code>Sink.COMMAND_TARGET</code>, to state whether
	 *                     this sink will handle locally issued commands or commands
	 *                     incoming from remote nodes.
	 * @param commandNames An array containing all the names of the vertical
	 *                     commands the new sink wants to handle.
	 * @throws ServiceException If some other sink is already registered for a
	 *                          member of the <code>commandNames</code> set.
	 */
	...
	/**
	 * Deregister a sink that is currently handling a given set of vertical
	 * commands.
	 * 
	 * @param side         One of the two constants <code>Sink.COMMAND_SOURCE</code>
	 *                     or <code>Sink.COMMAND_TARGET</code>, to state whether the
	 *                     sink to be removed is handling locally issued commands or
	 *                     commands incoming from remote nodes.
	 * @param commandNames An array containing all the names of the vertical
	 *                     commands currently handled by the sink to be removed.
	 * @throws ServiceException If a member of the <code>commandNames</code> set has
	 *                          no associated command sink.
	 */
	...
	/**
	 * Process an outgoing command object, carrying out the action it represents.
	 * This method is not synchronized and it must be reentrant and as fast as
	 * possible, because it is going to be a bottleneck of the kernel call flow.
	 * 
	...
	/**
	 * Process an incoming command object, carrying out the action it represents.
	 * This method is not synchronized and it must be reentrant and as fast as
	 * possible, because it is going to be a bottleneck of the kernel call flow.
	 * 
	 * @param cmd The <code>VerticalCommand</code> object to process.
	...
	/**
	 * Inner class SinksFilter. This class makes the set of sinks in a given
