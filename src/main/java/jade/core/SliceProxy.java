...
/**
 * An implementation of the <code>Service.Slice</code> interface, supporting
 * routed dispatching of horizontal commands.
 * 
 * @author Moreno LAGO
 */
public class SliceProxy implements Service.Slice {
	...
	public VerticalCommand serve(HorizontalCommand cmd) {
		try {
			...
			cmd.setReturnValue(new ServiceException(
					"An error occurred while routing the command to the remote implementation", imtpe));
		}
