...
public interface ServiceManager {
    ...
    */
    ...
    /**
       ...
       on the remote end.
    */
    void addNode(NodeDescriptor desc, List<ServiceDescriptor> services) throws IMTPException, ServiceException, JADESecurityException;
    ...
    */
    ...
    /**
     * Retrieve the list of locally installed services as a List of ServiceDescriptor objects
     * @return the list of locally installed services as a List of ServiceDescriptor objects
     */
    List<ServiceDescriptor> getLocalServices(); 
}
