...
public final class FipaMessageHelper {
	...
	public static synchronized org.omg.CORBA.TypeCode type() {
		...
		if (_tc == null) {
			...
			_members[0] = new org.omg.CORBA.StructMember("messageEnvelopes",
					org.omg.CORBA.ORB.init().create_sequence_tc(0, FIPA.EnvelopeHelper.type()), null);

			_members[1] = new org.omg.CORBA.StructMember("messageBody", org.omg.CORBA.ORB.init().create_sequence_tc(0,
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_octet)), null);
