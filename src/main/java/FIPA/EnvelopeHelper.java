...
public final class EnvelopeHelper {
	...
	public static synchronized org.omg.CORBA.TypeCode type() {
		...
		if (_tc == null) {
			...
			_members[0] = new org.omg.CORBA.StructMember("to",
					org.omg.CORBA.ORB.init().create_sequence_tc(0, FIPA.AgentIDHelper.type()), null);

			_members[1] = new org.omg.CORBA.StructMember("from",
					org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), FIPA.AgentIDHelper.type()), null);

			_members[2] = new org.omg.CORBA.StructMember("comments",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[3] = new org.omg.CORBA.StructMember("aclRepresentation",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[4] = new org.omg.CORBA.StructMember("payloadLength",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_long), null);

			_members[5] = new org.omg.CORBA.StructMember("payloadEncoding",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[6] = new org.omg.CORBA.StructMember("date",
					org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), FIPA.DateTimeHelper.type()), null);

			_members[7] = new org.omg.CORBA.StructMember("encrypted", org.omg.CORBA.ORB.init().create_sequence_tc(0,
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string)), null);

			_members[8] = new org.omg.CORBA.StructMember("intendedReceiver",
					org.omg.CORBA.ORB.init().create_sequence_tc(0, FIPA.AgentIDHelper.type()), null);

			_members[9] = new org.omg.CORBA.StructMember("received",
					org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L), FIPA.ReceivedObjectHelper.type()), null);

			_members[10] = new org.omg.CORBA.StructMember("transportBehaviour",
					org.omg.CORBA.ORB.init().create_sequence_tc((int) (1L),
							org.omg.CORBA.ORB.init().create_sequence_tc(0, FIPA.PropertyHelper.type())),
					null);

			_members[11] = new org.omg.CORBA.StructMember("userDefinedProperties",
					org.omg.CORBA.ORB.init().create_sequence_tc(0, FIPA.PropertyHelper.type()), null);
