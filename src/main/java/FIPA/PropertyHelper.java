...
public final class PropertyHelper {
	...
	public static synchronized org.omg.CORBA.TypeCode type() {
		...
		if (_tc == null) {
			...
			_members[0] = new org.omg.CORBA.StructMember("keyword",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[1] = new org.omg.CORBA.StructMember("value",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_any), null);
