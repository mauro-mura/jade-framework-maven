...
public class AgentIDHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		...
		if (_tc == null) {
			...
			_members[0] = new org.omg.CORBA.StructMember("name",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[1] = new org.omg.CORBA.StructMember("addresses", org.omg.CORBA.ORB.init().create_sequence_tc(0,
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string)), null);

			_members[2] = new org.omg.CORBA.StructMember("resolvers",
			...
			_members[3] = new org.omg.CORBA.StructMember("userDefinedProperties",
