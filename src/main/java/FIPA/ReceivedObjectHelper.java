...
public class ReceivedObjectHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		...
		if (_tc == null) {
			...
			_members[0] = new org.omg.CORBA.StructMember("by",
			...
			_members[2] = new org.omg.CORBA.StructMember("date", FIPA.DateTimeHelper.type(), null);

			_members[3] = new org.omg.CORBA.StructMember("id",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);

			_members[4] = new org.omg.CORBA.StructMember("via",
					org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string), null);
